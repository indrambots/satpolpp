...
return [
    ...
    */
    ...
    'attributes' => [
      ...
      'unit_id' => "Unit Kerja",
      'header_id' => "Header",
      'realisasi_kolom_ke' => "Realisasi Kolom Ke-",
      'jenis_realisasi' => "Jenis Realisasi",
      'jenis_realisasi_sd' => "Jenis Realisasi Sampai Dengan",
      'filter_realisasi_sd' => "Filter Realisasi Sampai Dengan",
      'data_master_is_one_pd' => "Pilihan Satu PD ",
      'data_master_nama' => "Nama Data Master ",
      'urusan_kode' => "Kode Urusan ",
      'data_master_ket' => "Keterangan Data Master ",
      'data_id' => "Data Atom Id ",
    ],
];
