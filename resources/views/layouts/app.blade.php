  ...
  gtag('config', 'G-44S1H0GN2F');
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed page-loading">
        ...
        <div id="kt_header_mobile" class="header-mobile bg-primary header-mobile-fixed">
            <!--begin::Logo-->
            <a href="{{ url('/') }}">
                <img alt="Logo" src="{{ asset('assets/img/icon/logo-sby.png') }}" class="max-h-40px" />
            </a>
            <div class="topbar-item">
                <a href="{url('/')} " class="mr-20">
                    <img alt="Logo" src="{{ asset('assets/img/icon/logo-baru.png') }}" class="max-h-35px">
                </a>
            </div>
            <!--end::Logo-->
            <!--begin::Toolbar-->
                        ...
                        <div class="header-top" style="background-color:white;">
                            ...
                            <div class="container">
                                ...
                                <div class="d-none d-lg-flex align-items-center mr-3">
                                    ...
                                    <div class="topbar-item">
                                        <a href="{{ url('/') }}" class="mr-20">
                                            <img alt="Logo" src="{{ asset('assets/landing/img/logo_bappeko_2022.png') }}" class="max-h-70px">
                                        </a>
									</div>
                                    <!--begin::Logo-->
                                </div>
                                ...
                                <div class="topbar">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        @if (Auth::user()->level <=5)
                                            {{-- <div class="topbar-item ">
                                                <a class="btn btn-icon btn-outline-info w-auto d-flex align-items-center px-2" href="{{ asset('files/buku_panduan_inovasi_pd.pdf')  }}" download="">
                                                    <span class="symbol symbol-35">
                                                        <i class=" mb-10 mt-10 fa fa-file-pdf-o" aria-hidden="true"></i>
                                                        Dokumen Petunjuk
                                                    </span>
                                                </a>
                                            </div> --}}
