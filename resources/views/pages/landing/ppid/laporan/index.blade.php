                ...
                <div class="row text-right-rtl">
                    ...
                    <div class="col-xl-6">
                        <div class="about-style2__image">
                            <div class="outer-text">LAPORAN TAHUNAN PPID</div>
                            <div class="inner-box">
                                <div class="icon">
                                    ...
                                    <div class="table-responsive">
                                        <table id="datatable" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td>LAPORAN LAYANAN INFORMASI PUBLIK TAHUN 2022 </td>
                                                    <td><a target="_blank" href="https://drive.google.com/file/d/1YDtjpuqXk7WY0ppSqbptLXAs1bBpoGHY/view?usp=sharing" class="btn btn-md btn-primary" style="color: white;"> LIHAT DOKUMEN</a></td>
                                                </tr>
                                            </tbody>
                                          </table>
                                        </div>
