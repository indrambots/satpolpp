                ...
                <div class="row text-right-rtl">
                    ...
                    <div class="col-xl-6">
                        <div class="about-style2__image">
                            <div class="outer-text">Laporan Kinerja</div>
                            <div class="inner-box">
                                <div class="icon">
                                    <span class="icon-picasa-logo"></span>
                                </div>
                                <div class="img-box float-bob-y">
                                    <img style="width: 750px; height: 600px;" src="{{ asset('assets/landing/images/icon/laporan_kinerja.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-6">
                        <div class="about-style2__content">
                            <div class="sec-title">
                                ...
                                <h2> Laporan Kinerja Satuan Polisi Pamong Praja Provinsi Jawa Timur
                                </h2>
                            </div>
...
<script type="text/javascript">
    var datatable = $('#datatable').DataTable({
        ...
        serverSide: false,
        paging:true,
        ajax:'{{ url('page/laporan-datatable/2') }}',
         columns: [
        {data: 'id', name:'id'},
        {data: 'nama', name:'nama'},
        {data: 'aksi', name:'aksi'},
