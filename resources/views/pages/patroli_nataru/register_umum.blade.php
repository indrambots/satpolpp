    ...
    <div class="col-12 col-lg-12 col-xl-12 mb-2">
        <div class="card card-custom wave wave-animate-fast wave-primary">
            <div class="card-body text-center">
                <h1>
                    REGISTERASI PATROLI SIJALINMAJATARU MAsYARAKAT UMUM
                </h1>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-custom gutter-b example example-compact">
            ...
            <!--begin::Form-->
            <form class="form" method="POST" action="{{ url('patroli/save-umum') }}">
            {{ csrf_field() }}
                <div class="card-body">
                    <div class="form-group">
                        <label class="mr-20">
                         ...
                         <select style="width:90%" class="select2  form-control" id="kota" name="kota"  required >
                            ...
                            @foreach($kota as $k)
                                <option value="{{ $k->nm_kab }}">{{ $k->nm_kab }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        <label class="mr-20">
                         ...
                         <select style="width:90%" class="select2  form-control" id="organisasi" name="organisasi"  required >
                            <option value="">--Pilih Organisasi--</option>
                            <option value="Pramuka">PRAMUKA</option>
                            <option value="Karang Taruna">Karang Taruna</option>
                            <option value="Karang Taruna">Lainnya</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>
