...
<div class="modal fade" id="modal-upload" tabindex="-1" aria-labelledby="exampleModalLabel" aria-modal="true" role="dialog">
  <div class="modal-dialog modal-lg">
    <form id="frm_upload_berita" enctype="multipart/form-data" method="POST" action="{{ url('admin/berita/upload') }}">
      {{ csrf_field() }}
    ...
    <div class="modal-content">
      <div class="modal-header bg-diagonal bg-diagonal-primary bg-diagonal-r-light">
        <h5 class="modal-title text-white" style="z-index:1;" id="exampleModalLabel"><i class="far fa-lightbulb text-white"></i> Form Upload Gambar Terkait Berita</h5>
      </div>
